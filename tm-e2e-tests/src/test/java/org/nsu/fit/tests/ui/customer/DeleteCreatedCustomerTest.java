...
public class DeleteCreatedCustomerTest {
    ...
    public void deleteCustomerTest() {
        result.searchCustomer(customerPojo.login).deleteFirstCreatedCustomer();
        assertFalse(browser.isElementPresent(By.xpath("//*[@id='root']/div/div/div/div/div[1]/div[2]/div/div/div/table/tbody/tr[td='" + customerPojo.login + "']/td")));
    }
