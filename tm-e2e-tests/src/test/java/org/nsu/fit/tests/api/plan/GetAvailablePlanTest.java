...
public class GetAvailablePlanTest {
    ...
    @Feature("Get available plans for customer feature")
    ...
    @Test(description = "Get available plans for customer", dependsOnMethods = "createPlanTest")
    @Severity(SeverityLevel.BLOCKER)
    @Feature("Get available plans for customer feature")
    public void getAvailablePlansTest() {
        ...
        PlanPojo resPlanPojo = result.get(0);
        assertEquals(planPojo.name, resPlanPojo.name);
        assertEquals(planPojo.details, resPlanPojo.details);
        assertEquals(planPojo.fee, resPlanPojo.fee);
    }
